...
export function LoginScreen({ onSignIn, onGoogleSignIn }: Props) {
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <div className="max-w-sm mx-auto mb-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 font-bold py-3 px-5 rounded-xl transition-all text-sm"
        ...
        {/* Divider */}
        <div className="max-w-sm mx-auto flex items-center gap-3 mb-4">
          <div className="flex-1 h-px" style={{ background: 'var(--border)' }} />
          <span className="text-xs" style={{ color: 'var(--text-muted)' }}>oder per E-Mail</span>
          <div className="flex-1 h-px" style={{ background: 'var(--border)' }} />
        </div>
